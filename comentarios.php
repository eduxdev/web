...
<?php if (count($comentarios_pagados) > 0): ?>
    <div class="mt-8">
        <h2 class="text-2xl font-bold mb-4 text-center">Comentarios Pagados</h2>
            ...
            <div class="border rounded p-4 mb-4 shadow-sm">
                ...
                <?php if (!empty($comentario['media'])): ?>
                    <div class="mt-2">
                        ...
                        <?php else: ?>
                            <p class="text-base font-bold"><strong>Media:</strong> <?php echo nl2br(htmlspecialchars($comentario['media'])); ?></p>
                        <?php endif; ?>
                    </div>
                <?php endif; ?>
            </div>
        ...
        <div class="flex justify-center space-x-2 mt-4">
            <?php if ($page > 1): ?>
                <a href="?flag=<?php echo urlencode($flag); ?>&page=<?php echo $page - 1; ?>" class="px-3 py-1 text-base bg-gray-200 rounded hover:bg-gray-300">Anterior</a>
            <?php endif; ?>
            <?php for ($i = 1; $i <= $total_pages; $i++): ?>
                <a href="?flag=<?php echo urlencode($flag); ?>&page=<?php echo $i; ?>" class="px-3 py-1 text-base rounded <?php echo ($i == $page) ? 'bg-blue-500 text-white' : 'bg-gray-200 hover:bg-gray-300'; ?>">
                    <?php echo $i; ?>
                </a>
            <?php endfor; ?>
            <?php if ($page < $total_pages): ?>
                <a href="?flag=<?php echo urlencode($flag); ?>&page=<?php echo $page + 1; ?>" class="px-3 py-1 text-base bg-gray-200 rounded hover:bg-gray-300">Siguiente</a>
            <?php endif; ?>
        </div>
    </div>
<?php endif; ?>
...
<?php if (isset($error)): ?>
    <div class="bg-red-100 border border-red-400 text-red-700 px-3 py-1 rounded mb-2" role="alert">
        <?php echo $error; ?>
    </div>
<?php endif; ?>
        ...
        <div class="mt-8">
            <h2 class="text-2xl font-bold mb-4">Anuncios Gratis</h2>
        ...
        <div class="mt-3 flex justify-center">
            <button onclick="window.location.href='index.php'" class="bg-blue-500 hover:bg-blue-700 text-white font-bold px-4 py-2 rounded shadow transition-all duration-300">
