...
<head>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            // Si existen campos en el formulario, recuperar datos de localStorage
            if (document.getElementById('username') && localStorage.getItem('username')) {
                document.getElementById('username').value = localStorage.getItem('username');
            }
            if (document.getElementById('comentario') && localStorage.getItem('comentario')) {
                document.getElementById('comentario').value = localStorage.getItem('comentario');
            }
            // Guardar cambios en localStorage (si se desea conservar la info antes del pago)
            ...
            <div class="flex flex-col space-y-4">
                ...
                <div class="flex justify-around">
                    ...
                    <div class="flex space-x-4">
                        ...
                        <a href="checkout.php?option=media" target="_blank" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
